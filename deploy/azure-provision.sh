...
ACME_EMAIL=REPLACE_you@gocheckpro.com   # for Let's Encrypt registration
PG_ADMIN=ipadmin
...
RG=gocheckpro-rg
ACR=gocheckproacr$RANDOM           # globally unique, lowercase alnum
AKS=gocheckpro-aks
...
echo "==> Azure Cache for Redis ($REDIS)  (this one takes ~15-20 min)"
...
------------------------- SAVE THESE SECRETS -------------------------------
 ...
 Redis host       : $REDIS_HOST  (port 6380, TLS)
 Redis key        : $REDIS_KEY
 Ingress IP       : $IP
============================================================================
SUMMARY
